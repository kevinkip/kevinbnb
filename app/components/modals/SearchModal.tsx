...
enum STEPS { //enum is similar to const. Defining a variable
    LOCATION = 0,
    DATE = 1,
    INFO = 2
}
...
const SearchModal = () => {
    const router = useRouter() //access routes in this 
    ...
    return (
        <Modal isOpen={searchModal.isOpen} title="Filters" actionLabel={actionLabel} onSubmit={onSubmit} secondaryAction={step === STEPS.LOCATION ? undefined : onBack} secondaryActionLabel={secondaryActionLabel} onClose={searchModal.onClose} body={bodyContent} />
    )
}
